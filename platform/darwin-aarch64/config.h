...
#define FFMPEG_CONFIGURATION "--extra-ldflags='\0-ldl\0' --disable-xlib --enable-pic --extra-ldflags='\0-L/usr/local/google/home/jansene/src/emu-main-next/prebuilts/android-emulator-build/common/libvpx//lib\0' --enable-libx264 --extra-cflags=-ffast-math --extra-cflags='\0-I/usr/local/google/home/jansene/src/emu-main-next/prebuilts/android-emulator-build/common/x264//include\0' --extra-cflags='\0-I/usr/local/google/home/jansene/src/emu-main-next/prebuilts/android-emulator-build/common/libvpx//include\0' --enable-static --disable-doc --disable-programs --enable-gpl --disable-avdevice --disable-filters --enable-libvpx --disable-muxers --enable-muxer=gif --enable-muxer=webm --enable-muxer=webm_chunk_muxer --enable-muxer=webm_dash_manifest_muxer --disable-demuxers --enable-demuxer=webm --enable-demuxer=matroska --enable-demuxer=webm_chunk_muxer --enable-demuxer=mov --enable-demuxer=webm_dash_manifest_muxer --disable-protocols --enable-protocol=file --disable-encoders --enable-encoder=gif --enable-encoder=libvpx_vp9 --enable-encoder=opus --disable-decoders --enable-decoder=gif --enable-decoder=libvpx_vp9 --enable-decoder=opus --enable-decoder=hevc --enable-decoder=h264"
