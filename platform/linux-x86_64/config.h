...
#define FFMPEG_CONFIGURATION "--extra-ldflags='\"-ldl\"' --disable-xlib --enable-pic --extra-ldflags='\"-L/usr/local/google/home/jansene/src/emu-main-next/prebuilts/android-emulator-build/common/libvpx//lib\"' --enable-libx264 --extra-cflags=-ffast-math --extra-cflags='\"-I/usr/local/google/home/jansene/src/emu-main-next/prebuilts/android-emulator-build/common/x264//include\"' --extra-cflags='\"-I/usr/local/google/home/jansene/src/emu-main-next/prebuilts/android-emulator-build/common/libvpx//include\"' --enable-static --disable-doc --disable-programs --enable-gpl --disable-avdevice --disable-filters --enable-libvpx --disable-muxers --enable-muxer=gif --enable-muxer=webm --enable-muxer=webm_chunk_muxer --enable-muxer=webm_dash_manifest_muxer --disable-demuxers --enable-demuxer=webm --enable-demuxer=matroska --enable-demuxer=webm_chunk_muxer --enable-demuxer=mov --enable-demuxer=webm_dash_manifest_muxer --disable-protocols --enable-protocol=file --disable-encoders --enable-encoder=gif --enable-encoder=libvpx_vp9 --enable-encoder=opus --disable-decoders --enable-decoder=gif --enable-decoder=libvpx_vp9 --enable-decoder=opus --enable-decoder=hevc --enable-decoder=h264"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2026
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "gcc 14 (Debian 14.2.0-19+build5)"
